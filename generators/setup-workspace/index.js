...
class Generator extends Base {
  ...
  writing() {
    ...
    return Promise.resolve(1)
      ...
      .then(() => GeneratorUtils.yo('workspace', {defaultApp: this.defaultApp, skipNextStepsLog: true, updateWorkspaceScss: !fs.existsSync(this.destinationPath('workspaces.scss'))}, null, this.cwd, this.env.adapter))
