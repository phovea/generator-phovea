...
* [ ] Replace git dependencies in *requirements.txt* with new version range (e.g., `tdp_core>=15.0.0,<16.0.0` when published on pipy **or** `git+https://github.com/datavisyn/tdp_core.git@v15.0.0#egg=tdp_core` for non-published repositories)
