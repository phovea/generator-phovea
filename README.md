...
| `yo phovea:add-dependency` | Add an additionals plugin or external libraries to the current plugin |
| `yo phovea:add-extension`  | Add an additionals web or server extension to the current plugin |
